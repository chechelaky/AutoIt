...
;Sprite(	$S_Spriteplane, 	$S_offsetX, 	$S_offsetY, $S_WIDTH, 	$S_HEIGHT, 	$S_FRAMES, 	$S_START_FRAME, $S_FRAME_SPEED, $S_posX, 	$S_posY)
Func Sprite($S_SPRITE_PIC, 		$S_offsetX, 	$S_offsetY, $S_WIDTH, 	$S_HEIGHT, 	$S_FRAMES, 	$S_START_FRAME, $S_FRAME_SPEED, $S_posX, 	$S_posY, $wer = 0)
	$WIN_TILLE = WinGetTitle("","")
	$WIN_GETHANDLE = WinGetHandle($WIN_TILLE,"")
	$RAW_HDC = DllCall("user32.dll","ptr","GetDC","hwnd",$WIN_GETHANDLE)
	$hDC     = "0x" & Hex($RAW_HDC[0])
