...
Global $hShot = _GDIPlus_ImageLoadFromFile("shot.png")

Global $tSound1 = Add_Sound(@ScriptDir & "\sounds\shot00.wav")
Global $tSound2 = Add_Sound(@ScriptDir & "\sounds\shot01.wav")
Global $tSound3 = Add_Sound(@ScriptDir & "\sounds\shot02.wav")
Global $tSound4 = Add_Sound(@ScriptDir & "\sounds\impacto.wav")
...
Global $aPontos = MAPA("teste.json")
...
Func Image_Add($sFile)
	...
	$ds.handle = _GDIPlus_ImageLoadFromFile($sFile)
