...
$hMapPos = GUICtrlCreateLabel('aMousePos[*]', 600, 100, 120, 20)
...
Func _box($hToGraphic, $xx, $yy, $iWidth, $iHeight, $color = 0xFF000000)
	; _box2
	Local $aBox[5][2]
	$aBox[0][0] = 4
	$aBox[1][0] = $xx
	$aBox[1][1] = $yy
	$aBox[2][0] = $xx + $iWidth - 1
	$aBox[2][1] = $yy
	$aBox[3][0] = $xx + $iWidth - 1
	$aBox[3][1] = $yy + $iHeight - 1
	$aBox[4][0] = $xx
	$aBox[4][1] = $yy + $iHeight - 1
	If $color Then
